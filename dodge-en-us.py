...
def game_loop():
    ...
    while True:
        ...
        draw_text(screen, f"Record: {highscore}", 18, WIDTH - 10, 10, center=False)
        ...
        if paused and not game_over:
            ...
            draw_text(screen, "PAUSED", 36, WIDTH // 2, HEIGHT // 2 - 20)
            draw_text(screen, "Press P to continue", 20, WIDTH // 2, HEIGHT // 2 + 20)
        ...
        if game_over:
            ...
            draw_text(screen, "R = Restart  |  ESC = Quit", 20, WIDTH // 2, HEIGHT // 2 + 40)
